                                        ...
                                        <?php foreach ($alluser as $k=> $allusers) { ;?>
                                            ...
                                            <td>           <div class="btn-group mb-2">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="prompt?user_id=<?php echo $allusers->withdraw_id  ?>&action=deletel">Delate</a>
                                                        <a class="dropdown-item" href="prompt?user_id=<?php echo $allusers->withdraw_id  ?>&action=<?php echo $allusers->status === 'confirmed' ? 'pending':'confirmed'; ?>"><?php echo $allusers->status === 'confirmed' ? 'pending':'confirmed'; ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                            <?php $no++; } ?>
