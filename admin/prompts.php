        ...
        <div class="col-xs-12 col-xs-offset-0 col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3">
            ...
            <div class="text-center" style="margin-top: 10px">
                <form action="../action/main_work?option=<?php echo $action ;?>" method="post">
                    ...
                    <?php if($action === 'deletepl'){?>
                        <button type="submit" class="btn-info-<?php if($action === 'deletepl'){ print 'danger'; } else{ echo 'success'; } ?> btn-lg">Yes</button>
                        <a href="view_allplans" class="btn btn-success btn-lg">No</a>
                   <?php } else{ ?>
                    
                    <button type="submit" class="btn-info-<?php if($action === 'delete'){ print 'danger'; } else{ echo 'success'; } ?> btn-lg">Yes</button>
                    <a href="all_deposit" class="btn btn-success btn-lg">No</a>
                 <?php  } ?>
