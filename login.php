...
<div class="nk-app-root">
    <div class="nk-wrap">
        <div class="nk-block nk-block-middle nk-auth-body wide-xs">
            ...
            <div class="brand-logo text-center mb-2 pb-4"><img style="height: 100px; padding-top: -10px" src="images/<?php echo $CompanyLogo ?>" alt="<?php echo $CompanyName ?>">
    ...
    <div class="container wide-lg">
            ...
            <div class="col-lg-6">
                <div class="nk-block-content text-center text-lg-left">
                    <p class="text-soft"><?php echo $CompanyName ?>&copy; 2022. All Rights Reserved.</p>
                </div>
            </div>
        </div>
            </div>
